...
from app.domain.post.entity import PostInDB, Post, ManyPostResponse
...
class ListPostRequestObject(request_object.ValidRequestObject):
    ...
    def builder(cls, page_index: int = 1, page_size: int = 20):
        return ListPostRequestObject(page_index=page_index, page_size=page_size)
...
class ListPostUseCase(use_case.UseCase):
    ...
    def process_request(self, req_object: ListPostRequestObject):
        ...
        total = self.post_repository.count()
